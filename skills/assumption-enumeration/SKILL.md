...
description: Surface, perturb, and prioritize assumptions by disruption potential. Orchestrates assumption surfacing → perturbation → sacred cow identification → prioritization.
execution: tactic
used-by: axiom-negation, anti-benchmark, sacred-cow-hunting, assumption-destruction
---
