...
description: Enumerate implicit assumptions in a problem statement or existing solution. Produces categorized assumption inventory (physical, social, temporal, economic, technical).
execution: subagent
prompt: ./prompt.md
input: target_description (string), context (string)
used-by: assumption-destruction, lateral-thinking, perspective-forcing, structural-deconstruction
---
